...
import com.zekiloni.george.provisioning.infrastructure.in.web.catalog.mapper.OfferingDtoMapper;
import com.zekiloni.george.provisioning.infrastructure.in.web.order.dto.InvoiceDto;
import com.zekiloni.george.provisioning.infrastructure.in.web.order.dto.InvoiceItemDto;
import com.zekiloni.george.common.infrastructure.in.web.dto.MoneyDto;
import com.zekiloni.george.provisioning.infrastructure.in.web.order.dto.event.*;
...
public interface InvoiceDtoMapper {
    ...
    default <T extends InvoiceEvent> T createInvoiceEvent(@TargetType Class<T> targetType) {
        try {
            ...
            throw new RuntimeException("Failed to instantiate " + targetType.getSimpleName(), e);
        }
    }
}
